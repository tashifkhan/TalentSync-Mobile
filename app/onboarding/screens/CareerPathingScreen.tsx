			...
			<View style={styles.center}>
				...
				<View style={styles.collage}>
					<View style={[styles.tile, styles.tileCenter]}>
						<Ionicons name="compass-outline" size={40} color="#0a7ea4" />
					</View>
					<View style={[styles.tile, styles.tileLeft]}>
						<Ionicons name="document-text-outline" size={32} color="#0a7ea4" />
					</View>
					<View style={[styles.tile, styles.tileRight]}>
						<Ionicons name="mail-outline" size={32} color="#0a7ea4" />
					</View>
					<View style={[styles.tile, styles.tileBottom]}>
						<Ionicons name="pricetag-outline" size={32} color="#0a7ea4" />
					</View>
				</View>
